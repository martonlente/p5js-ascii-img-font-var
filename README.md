...
[p5js-ascii-img-font-var](https://p5js-ascii-img-font-var.martonlente.com) is a tool for generating ASCII art from images with simple UI controls and variable font support. Unlike traditional ASCII art tools, this project leverages variable font weights for enhanced visual output.
...
This project has also been inspired by Tim Rodenbröker's [courses](https://trcc.timrodenbroeker.de/courses) on creative coding.
